...
def Monster(mensagem): 
    ...
    with open('giassi/energetico/monsterGiassi.csv') as fp:
        line = fp.readlines()    
        nw11a = (line[1]) 
        nw11b = ((nw11a.replace('Â','')))
        nw11 = ((nw11b)) 
    ...
    bot.send_message(mensagem.chat.id,' Supermercado Giassi:') 
    bot.send_message(mensagem.chat.id, nw11)
